...
export const webpages: RawDictionary["webpages"] = {
  ...
  chrome_mode_default:       "Default",
  chrome_mode_compact:       "Compact — hide left nav",
  chrome_mode_wide:          "Wide — hide right sidebar",
  chrome_mode_focus:         "Focus — hide nav & sidebar",
  chrome_mode_zen:           "Zen — content only",
  chrome_mode_hint:          "Pages using this template use this chrome mode",
  zen_chrome_notice:         "Zen chrome hides all widget areas — anything placed here won't appear on the live page.",
