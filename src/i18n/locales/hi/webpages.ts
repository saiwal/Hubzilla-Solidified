...
export const webpages: RawDictionary["webpages"] = {
  ...
  chrome_mode_default:       "डिफ़ॉल्ट",
  chrome_mode_compact:       "कॉम्पैक्ट — बायाँ नेव छुपाएँ",
  chrome_mode_wide:          "वाइड — दायाँ साइडबार छुपाएँ",
  chrome_mode_focus:         "फोकस — नेव और साइडबार छुपाएँ",
  chrome_mode_zen:           "ज़ेन — केवल सामग्री",
  chrome_mode_hint:          "इस टेम्पलेट का उपयोग करने वाले पेज इसी क्रोम मोड का उपयोग करते हैं",
  zen_chrome_notice:         "ज़ेन क्रोम सभी विजेट क्षेत्रों को छुपा देता है — यहाँ रखी गई कोई भी चीज़ लाइव पेज पर दिखाई नहीं देगी।",
