...
Streams and Forte have no bundled icon (no official standalone logo asset was
available at the time this was added) — they render the existing letter-monogram
fallback in `PlatformIcons.tsx` instead.
