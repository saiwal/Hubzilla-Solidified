 ...
 */
function __THEME_SLUG___assets(): array
{
    static $assets = null;
    if ($assets !== null) {
        return $assets;
    ...
    $base = '/view/theme/__THEME_SLUG__/assets';
    $assets = [
        'js'  => $base . '/app.js',
        'css' => [$base . '/app.css'],
    ];

    $manifest_path = PROJECT_BASE . '/view/theme/__THEME_SLUG__/assets/.vite/manifest.json';
